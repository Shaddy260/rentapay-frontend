...
const ScoutSignup = lazy(() => import('./pages/ScoutSignup.jsx'));
const ScoutPortal = lazy(() => import('./pages/ScoutPortal.jsx'));
const ScoutVacancies = lazy(() => import('./pages/ScoutVacancies.jsx'));
    ...
    <BrowserRouter>
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          <Route path="/scout" element={<ScoutSignup />} />
          <Route path="/scout-portal" element={<ScoutPortal />} />
          <Route path="/scout-vacancies" element={<ScoutVacancies />} />
