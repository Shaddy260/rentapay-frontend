...
![Landlord dashboard: overdue tenants, amount paid this month, vacant units, subscription days left, and quick actions](./images/real/landlord-dashboard-overview.png)
...
![Landlord home screen: pending payment confirmations, tenant onboarding link, and units filtered to Overdue](./images/real/landlord-units-overdue.png)
...
![Landlord units list continued: Paid tenants, vacant count, and unused slots](./images/real/landlord-units-paid-vacant.png)
*Real product screenshot. Tenant names and amounts shown are illustrative.*
...
![A unit's edit screen: photos, listing status, rent and due date, and payment method](./images/real/landlord-unit-detail.png)
...
![Landlord sidebar menu: Overview, Finances, Tenants, Operations, Account sections](./images/real/landlord-sidebar-menu.png)
![Finances menu expanded: Financial Statistics, Payment History, Disputed Charges, Payment Plan Requests, Pending Payments](./images/real/landlord-sidebar-finances.png)
