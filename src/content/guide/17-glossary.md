...
**Confirmed payment.** A payment submission a landlord, manager, or caretaker has
manually reviewed and accepted as genuinely received.

**Daraja API.** Safaricom's own interface for initiating and receiving M Pesa
transactions, used by RentaPay for a landlord's automatic subscription payments.
