...
**A payment is taking a long time to confirm.** Confirmation is a manual review
step performed by whoever manages the unit. If it has been longer than a few
hours, reach out to your landlord, manager, or caretaker directly. If it still
cannot be resolved between you, use the in app dispute tool to create a shared,
timestamped record of the issue.
