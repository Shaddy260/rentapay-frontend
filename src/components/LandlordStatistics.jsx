...
export default function LandlordStatistics({ token, propertyId, isCaretaker = false }) {
  ...
  if (loading && !stats) return <section className="statistics-panel"><p>Loading statistics…</p></section>;
  ...
  return (
    <section className="statistics-panel">
      <div className="tenant-section__header-row">
        <h2>Financial Statistics</h2>
        <button className="ghost-link" data-download-fx onClick={handleDownloadPdf} disabled={downloadingPdf}>
