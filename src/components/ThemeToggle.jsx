...
// AccountMenu so every portal (landlord, tenant, manager) gets
...
export default function ThemeToggleItem({ className, onToggle }) {
  ...
  return (
    <button
      ...
      onClick={() => {
        ...
        // the menu should disappear unless opened again"): closes the
        // dropdown this toggle lives inside (AccountMenu), same as
        // every other item in that menu.
        onToggle?.();
      }}
    >
