                ...
                {isExpanded && (
                  <div className="admin-ba-payout__detail">
                    ...
                    <div className="admin-ba-payout__actions">
                      ...
                      <Button onClick={() => downloadStatement(row.ba.id)} data-download-fx variant="ghost">
                        Download Statement
                      </Button>
                      <Button onClick={() => downloadEarningsStatement(row.ba.id, 'pdf')} data-download-fx variant="ghost">
                        Statement PDF
                      </Button>
                      <Button onClick={() => downloadEarningsStatement(row.ba.id, 'csv')} data-download-fx variant="ghost">
                        Statement CSV
                      </Button>
                    </div>
                  </div>
