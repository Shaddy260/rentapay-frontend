            ...
            <tbody>
              {archived.map((t) => (
                <tr key={t.id}>
                  ...
                  <td>
                    {t.claimedElsewhere ? (
                      <span className="archived-tenants__claimed" title={`Now active under ${t.claimedElsewhere.landlordName}`}>
                        Active elsewhere
                      </span>
                    ) : (
                      <button type="button" className="ghost-link" onClick={() => openRestore(t)}>Restore</button>
                    )}
                  </td>
                </tr>
              ))}
