...
export default function LandlordManualPaymentConfirmations({ token }) {
  ...
  async function handleConfirm(item) {
    ...
    setError('');
    try {
      await api.confirmManualSubscriptionPayment(item.id, token);
  ...
  async function handleReject(item) {
    ...
    setError('');
    try {
      await api.rejectManualSubscriptionPayment(item.id, rejectReason.trim(), token);
  ...
  async function handleDelete() {
    ...
    setError('');
    try {
      await api.deleteManualSubscriptionPayment(deleteTarget.id, token);
