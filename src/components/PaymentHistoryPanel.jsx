 ...
 */
export default function PaymentHistoryPanel({ token, role = 'landlord', propertyId, propertyIdReady = true, canDelete = true }) {
      ...
      {payments.length === 0 ? (
        ...
        <div className="payments-table-wrap">
          <table className="payments-table">
            <thead>
              <tr><th>Date</th><th>Tenant</th><th>Unit</th><th>Amount</th><th>Method</th><th>Status</th><th></th>{canDelete && <th></th>}</tr>
            </thead>
            <tbody>
              {payments.map((p) => (
                <tr key={p.id}>
