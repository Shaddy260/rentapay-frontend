  ...
  useEffect(() => {
    ...
    previewTimer.current = setTimeout(() => {
      api.previewLatePenalty({
        ...
        sampleAmount: 15000,
        periodsOverdue: 5,
      }, token).then(setPreview).catch((err) => {
        // Non-fatal: the live preview just doesn't update for this
        // keystroke. Logged so a broken preview endpoint isn't invisible.
        console.warn('[LatePenaltySettingsPanel] failed to load preview:', err);
      });
    }, 250);
