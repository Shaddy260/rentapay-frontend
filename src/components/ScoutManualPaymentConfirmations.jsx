 ...
 * Confirm activates the scout's subscription for every county in the
 * submission (see confirmManualCountyPayment / activateScoutCounties
 * in scout.controller.js for what that does under the hood).
 */
export default function ScoutManualPaymentConfirmations({ token }) {
  ...
  return (
    <section className="statistics-panel">
      <h2>Scout Manual Payment Confirmations</h2>
