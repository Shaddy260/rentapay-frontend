...
const FAQ_ITEMS = [
  {
    ...
    items: [
      {
        q: 'What is RentaPay?',
        a: 'RentaPay is a property management and operations platform built for the Kenyan market. Landlords track properties, units, and tenants in one place, and can bring on property managers or caretakers with their own scoped access; tenants view their balance and account from their phone. Rent payments are one part of this - tenants pay via M-Pesa (Paybill, Till, or Send Money) and submit their code, which a landlord, manager, or caretaker reviews and confirms - alongside the day-to-day work of running a property.',
      },
      {
        q: 'How does a rent payment actually move through the system?',
        a: "A tenant pays via M-Pesa - Paybill, Till, or Send Money to the number their landlord has on file - then submits the M-Pesa transaction code, amount, and payer details in their portal. A landlord, manager, or caretaker reviews and confirms it (usually within a few minutes to a few hours), the tenant's balance updates, and a receipt is sent. If a tenant overpays, the extra amount is carried forward and reduces next month's balance rather than being lost.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "RentaPay is built to run your property's day-to-day operations - tenants, units, managers - with the same care as its payment handling. Rent payments run through M-Pesa directly, so RentaPay never holds your money: a tenant sends payment and submits their M-Pesa code, a landlord/manager/caretaker reviews and confirms it against the real M-Pesa receipt number, and every transaction stays independently verifiable.",
      },
      {
