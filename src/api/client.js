...
export const api = {
  ...
  referScoutUnit: (unitId, token, prospect) => request('/scout/refer', { method: 'POST', body: { unitId, ...prospect }, token }),
  getMyScoutReferrals: (token) => request('/scout/my-referrals', { token }),
  getScoutLeaderboard: (token) => request('/scout/leaderboard', { token }),
  advanceScoutReferralStage: (referralId, stage, token) => request(`/scout/referrals/${referralId}/stage`, { method: 'PATCH', body: { stage }, token }),
