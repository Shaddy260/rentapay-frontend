...
export const api = {
  ...
  listLatePenaltyOverrides: (tenantId, token) => request(`/late-penalty/tenants/${tenantId}/overrides`, { token }),
  ...
  removeLatePenaltyOverride: (overrideId, token) => request(`/late-penalty/overrides/${overrideId}`, { method: 'DELETE', token }),
