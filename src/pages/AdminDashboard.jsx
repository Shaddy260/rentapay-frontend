...
export default function AdminDashboard() {
  ...
  const [sidebarCounts, setSidebarCounts] = useState({ help: 0, landlordPayments: 0, messages: 0 });
  ...
  const loadSidebarCounts = useCallback(() => {
    ...
    Promise.allSettled([
    ...
    ]).then(([helpRes, landlordPayRes, threadsRes]) => {
      ...
      const messages =
        threadsRes.status === 'fulfilled'
          ...
          : 0;
      setSidebarCounts({ help, landlordPayments, messages });
    });
  }, [token]);
