    ...
    <div className="landing">
      ...
      <section className="landing__audiences">
        <div className="landing__audience-card">
          ...
          {/* FIX (direct request: signup page "assumes all managers are
              under a landlord") - this card names BOTH landlords and
              managers, but used to link straight to
              /register/setup?as=landlord and mark the signup gate as
              already passed, so anyone managing as their own agency
              (not staff under a landlord) never saw the actual
              landlord/manager choice at all and silently ended up with
              a plain landlord account instead of a labeled Property
              Manager one. Routes through the real gate (RegisterRoleGate.jsx)
              now, same as every other entry point, so the
              landlord/tenant/manager choice - and the manager's own
              independent-agency/under-a-landlord follow-up choice - is
              never skipped. */}
          <Link to="/register" className="landing__audience-link">
            Sign up →
          </Link>
        </div>
        <div className="landing__audience-card">
