...
export default function ForgotPassword() {
  ...
  // backend figures out which account(s) this phone number belongs to.
  ...
  async function performReset(pickedAccountType) {
    try {
      const res = await api.resetPassword(
        pickedAccountType ? { accountType: pickedAccountType, phone, otp, newPassword } : { phone, otp, newPassword }
      );
