                  ...
                  {['overdue', 'upcoming', 'paid'].map((statusKey) => {
                    ...
                    return (
                      <div className="units-group" key={statusKey}>
                        ...
                        {list.length === 0 ? (
                          <p className="units-group__empty">
                            {statusKey === 'overdue' && '🎉 No overdue tenants'}
                            {statusKey === 'upcoming' && 'Nothing due soon right now.'}
                            {statusKey === 'paid' && 'No payments cleared for this cycle yet.'}
                          </p>
                        ) : (
                  ...
                  <div className="units-group">
                    ...
                    {vacantExpanded && (
                      groupedUnits.vacant.length === 0 ? (
                        <p className="units-group__empty">No vacant units right now.</p>
                      ) : (
                        <>
                          <div className="units-tile-grid">
