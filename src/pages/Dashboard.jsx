...
export default function Dashboard() {
  ...
  // PRODUCTION ERROR HANDLING FIX: this page used blocking window.alert()
  // for both success and failure feedback on the remind actions below,
  // inconsistent with the toast.error()/toast.success() convention used
  // elsewhere in the app (HelpButton.jsx, PendingPaymentConfirmations.jsx,
  // TenantOnboardingPanel.jsx, etc.) - a native alert() also blocks the
  // whole tab, which reads as broken next to a modern dashboard UI.
  ...
  async function handleWhatsAppRemindOverdueTenant(tenant) {
    ...
    try {
      ...
      toast.error(err.message || 'Failed to open WhatsApp reminder.');
    } finally {
