...
import { finalizeLogin, REGISTER_SETUP_PATH } from '../utils/finalizeLogin.js';
...
export default function Login() {
  ...
  function handleLoginResponse(res, { fallbackIdentifier } = {}) {
    ...
    if (res.paymentPending) {
      ...
      // BUG FIX (same class of bug as finalizeLogin.js's landlord
      // resume redirect): this must land back inside the actual
      // wizard at RegisterFlow, never on RegisterRoleGate's "which of
      // these are you" picker, or a landlord mid manual payment gets
      // bounced to start over just like an incomplete setup did.
