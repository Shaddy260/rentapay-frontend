...
import ScoutVisibilityPanel from '../components/ScoutVisibilityPanel.jsx';
...
export default function Settings() {
  ...
  return (
    <div className="settings-page">
      ...
      {!isManager && (
        <section className="settings-card">
          ...
          <p className="tenant-portal-hint">
            Download everything RentaPay holds for your account - properties, units, tenants, payments, expenses, maintenance requests, and document records - as a single file you can keep.
          </p>
      ...
      {!isManager && <ScoutVisibilityPanel token={token} />}
