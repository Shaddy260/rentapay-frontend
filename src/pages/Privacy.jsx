    ...
    <div className="legal-page">
      <div className="legal-page__card">
        ...
        <p>
          ...
          subscription payment, and, where a landlord enables it, may also be involved in tenant
          rent collection. Safaricom receives the phone number and amount needed to process that
          specific transaction and returns transaction confirmation data back to RentaPay. RentaPay
          does not share any other personal information with Safaricom beyond what a standard M
          Pesa transaction itself requires.
        </p>
