...
//
// FIX (direct request: every apartment's settings should be
// independent, nothing shared across properties): dropped the
// "Property" dropdown / "All properties I manage" option - hard
// scoped to whichever property is currently open in the dashboard,
// same as BulkRentChangeModal.
export default function BulkDueDateChangeModal({ token, propertyId, propertyName, onClose, onDone }) {
